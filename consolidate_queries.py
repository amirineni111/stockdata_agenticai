"""Replace 8 cross-strategy queries with 2 consolidated ones."""
...
new_queries = '''CROSS_STRATEGY_QUERIES = {
    # ========================================================================
...
new_content = ''.join(lines[:929]) + new_queries + '\n' + ''.join(lines[1458:])

# Write back
with open('config/sql_queries.py', 'w', encoding='utf-8') as f:
    f.write(new_content)

print("✅ Replaced 8 queries with 2 consolidated queries")
print(f"  Old: Lines 930-1458 (529 lines)")
print(f"  New: {new_queries.count(chr(10))} lines")
print("  Queries: nse_all_categories, nasdaq_all_categories")
