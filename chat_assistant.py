...
def create_chat_agent() -> Agent:
    ...
    agent = Agent(
        ...
        backstory=(
            ...
            "- ml_trading_predictions (NASDAQ: predicted_signal, confidence_percentage, buy/sell_probability, signal_strength, direction_correct_1d, is_actionable, suppression_reason). "
            "Since June 2026 it holds ALL ~2,300 tickers daily; suppressed rows have is_actionable=0 and signal_strength='Suppressed'. "
            "For tradeable signals or accuracy stats ALWAYS filter ISNULL(is_actionable, 1) = 1\n"
