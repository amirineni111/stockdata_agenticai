...
def create_chat_agent() -> Agent:
    ...
    agent = Agent(
        ...
        backstory=(
            ...
            "ML PREDICTIONS:\n"
            "- ai_prediction_history (model_name, ticker, predicted_price, actual_price, direction_correct, model_confidence)\n"
            "- ml_trading_predictions (predicted_signal, confidence, buy/sell_probability)\n"
            "- ml_technical_indicators (sma, ema, macd, rsi, volatility)\n\n"
            "TECHNICAL SIGNALS:\n"
            ...
            "STRATEGY:\n"
            "- strategy1_tracking (ai_direction, predicted_change_pct, ai_confidence, tech_direction, tech_score, system_agreement, combined_score, trade_tier, stop_loss, take_profit, risk_level)\n"
            ...
            "- forex_ml_predictions (predicted_signal, signal_confidence, prob_buy/sell/hold)\n\n"
            "PERSONAL:\n"
