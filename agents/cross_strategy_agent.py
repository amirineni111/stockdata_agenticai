...
def create_cross_strategy_agent() -> Agent:
    ...
    agent = Agent(
        ...
        goal=(
            ...
            "Strategy 2 (AI 7-day price predictions) agree on direction, segmented "
        ...
        backstory=(
            ...
            "7-day ahead prices and derives direction from predicted vs current price. "
            ...
            "with days_ahead=7 filter). You organize findings into 4 price categories to help "
